...
namespace P24.WSDL
{
    public class P24WsdlDynamicClass
    {
        ...
        public P24WsdlDynamicClass (int p24Id, P24Mode wsdlMode, WsdlType wsdlType, WsdlVersion wsdlVersion)
        {
            // Maintandance fields
        ...
        private CompilerResults CreateP24Assemby()
        {
            ...
            if (this.wsdlMode == P24Mode.sandbox)
                mode = "sandbox";
            else
                mode = "secure";
